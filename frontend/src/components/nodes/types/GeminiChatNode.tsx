...
export const GeminiChatNode: React.FC<NodeComponentProps> = (props) => {
  const { data, id } = props;
  ...
  const customContent = (
    <>
      ...
      {executionData.isSuccess && (
        ...
        >
          <Typography variant="caption">Gemini response generated successfully</Typography>
        </Alert>
      )}
