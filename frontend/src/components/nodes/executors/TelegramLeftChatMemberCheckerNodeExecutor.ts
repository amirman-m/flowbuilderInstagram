// TelegramLeftChatMemberChecker Executor - checks Telegram webhook for leave events
...
export class TelegramLeftChatMemberCheckerNodeExecutor extends NodeExecutor {
  ...
  protected async validateInputs(inputs: Record<string, any>): Promise<void> {
    ...
    if (!inputs.message_data || typeof inputs.message_data !== 'object') {
      throw new Error("Telegram Left Chat Member Checker requires 'message_data' object input");
    }
  }
